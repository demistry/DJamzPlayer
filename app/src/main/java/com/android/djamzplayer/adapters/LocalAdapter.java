...
public class LocalAdapter extends RecyclerView.Adapter<LocalAdapter.LocalViewHolder> {
    ...
    public LocalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new LocalViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_local_song, parent, false));
    }
    ...
    public class LocalViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public LocalViewHolder(View itemView) {
            super(itemView);
            gridImageView = (ImageView) itemView.findViewById(R.id.img_music_cover);
