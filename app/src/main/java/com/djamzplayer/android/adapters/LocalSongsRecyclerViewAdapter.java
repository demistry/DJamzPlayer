...
public class LocalSongsRecyclerViewAdapter extends RecyclerView.Adapter<LocalSongsRecyclerViewAdapter.LocalSongsViewHolder> {
    ...
    public LocalSongsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(com.djamzplayer.android.R.layout.local_item_song, parent, false);
    ...
    class LocalSongsViewHolder extends RecyclerView.ViewHolder{
        ...
        private LocalSongsViewHolder(View itemView) {
            super(itemView);
            songTitle = (TextView) itemView.findViewById(com.djamzplayer.android.R.id.mini_song_title);
            artistName = (TextView) itemView.findViewById(com.djamzplayer.android.R.id.mini_artist_name);
            songDuration = (TextView) itemView.findViewById(com.djamzplayer.android.R.id.mini_time);
            albumCover = (ImageView) itemView.findViewById(com.djamzplayer.android.R.id.mini_album_cover);
            relativeLayout = (RelativeLayout) itemView.findViewById(com.djamzplayer.android.R.id.local_songs_rootview);
        }
    }
}
